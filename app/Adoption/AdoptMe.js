  ...
  return (
    <ScrollView>
      <View className="text-center rounded-lg">
        ...
        <View className="flex flex-row flex-wrap justify-between w-full p-10 border-3 border-gray-200 border-r-14 shadow-lg h-96 bg-white -mt-7 rounded-t-3xl">
          ...
          <Text className="  text-slate-500 text-gtext-base font-bold fixed text-base text-center left-10 top-2 mb-5 mx-10">
            {post.description}
          </Text>
          <TouchableOpacity
            ...
            onPress={goToDetails}
          >
            <Text className="text-white text-center text-xl w-full ">
              Adopt Me
            </Text>
          </TouchableOpacity>
        </View>
